...
//         <div className="theme" style={{padding:"0px", margin:"0px"}}>
//             <div className="theme-main" style={{padding:"0px", margin:"0px"}}>
...
//                 <div className="theme-questions" style={{padding:"0px", margin:"0px"}} >
//                     <div className={classes.themeStyle} >
//                         <div className="theme-questions-header" style={{padding:"0px", margin:"0px"}}>
